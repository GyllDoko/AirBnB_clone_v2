...
The front-end of v was designed from scratch using HTML5/CSS3 pages
...
AirBnB clone v2 supports the following classes:
...
The AirBnB clone v2 console can be run both interactively and non-interactively.
...
Alternatively, to use the AirBnB clone v2 console in interactive mode, run the
...
The AirBnB clone v2 console supports the following commands:
...
Unittests for the AirBnB clone v2 project are defined in the [tests](./tests)
...
## Authors :black_nib:
* **Gyll-christ DOKO ALFA** <[Github](https://github.com/GyllDoko)>
